...
|enter code here| dsadasdasdadasd |
|---------------|--|
|asdasdasdasd|asdasdasdasdasdasdasdlasdlkalsdkalsdklad|
|asdasdasdasd|asdasdasdasdasdasdasdlasdlkalsdkalsdklad|
|asdasdasdasd|asdasdasdasdasdasdasdlasdlkalsdkalsdklad|
|asdasdasdasd|asdasdasdasdasdasdasdlasdlkalsdkalsdklad|
    ...
    // Выполняем операцию XOR по битам
    
    for (let  i  =  0; i  <  maxLength; i++) {
    
    result  +=  paddedBinaryA[i] !==  paddedBinaryB[i] ?  "1"  :  "0";
    ...
    const  a  =  0b1010; // Десятичное значение: 10
    
    const  b  =  0b1100; // Десятичное значение: 12
    
    const  result  =  xorOperation(a, b);
    
    console.log(result); // Ожидаемый результат: 6 (двоичное значение: 110)
